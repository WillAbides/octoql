...
[`schema/octoql.schema.json`](../schema/octoql.schema.json) in this repository.
Downstream projects can point an editor at the committed file or at its raw
`main`-branch URL:
`https://raw.githubusercontent.com/WillAbides/octoql/main/schema/octoql.schema.json`.
