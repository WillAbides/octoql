...
type RepositorySelector struct {
	...
	Name         string       `json:"name"`
	DatabaseID   *testutil.ID `json:"databaseID,omitempty"`
...
type __premarshalRepositorySelector struct {
	...
	CreatedAfter json.RawMessage `json:"createdAfter,omitempty"`
}
...
type __premarshal__GitHubInputsInput struct {
	...
	OptionalPublishedDates [][][]json.RawMessage `json:"optionalPublishedDates,omitempty"`
}
