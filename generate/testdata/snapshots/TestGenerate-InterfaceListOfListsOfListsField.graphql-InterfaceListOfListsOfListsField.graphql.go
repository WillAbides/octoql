...
) (*octoql.Response[InterfaceListOfListOfListsFieldResponse], error) {
	return octoql.Do[InterfaceListOfListOfListsFieldResponse](
		context.Background(),
		client_,
		octoql.Operation{
			Name:  "InterfaceListOfListOfListsField",
